...
- (void)showMenuInView:(UIView *)view fromRect:(CGRect)rect menuItems:(NSArray *)menuItems selected:(YCXMenuSelectedItem)selectedItem {
    ...
    //kk六道添加
    UIImageView *kkCoverImgV = [[UIImageView alloc]initWithImage:[UIImage imageNamed:@"kkMessage_menu_cover"]];
    kkCoverImgV.frame = view.bounds;
    [overlay addSubview:kkCoverImgV];
...
//            gradientView.frame = (CGRect){kSeparatorInsetLeft, maxItemHeight, maxItemWidth - kSeparatorInsetLeft - kSeparatorInsetRight, kSeparatorHeight};
          gradientView.frame = (CGRect){kMarginX, maxItemHeight, maxItemWidth - kMarginX - kMarginX, kSeparatorHeight};
