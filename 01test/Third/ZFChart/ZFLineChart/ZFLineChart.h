...
//六道
//y轴，最大报警数值，超过这个数值，圆点显示红色,默认无限大
@property (nonatomic, assign) CGFloat overMaxValueCircleNum;
//y轴，最小报警数值，低于这个数值，圆点显示红色,默认无限小
@property (nonatomic, assign) CGFloat overMinValueCircleNum;
